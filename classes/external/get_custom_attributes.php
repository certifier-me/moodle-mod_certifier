...
/**
 * External API for loading Certifier custom attribute options.
 *
 ...
 * @license    https://www.gnu.org/copyleft/gpl.html GNU GPL v3 or later
 */
class get_custom_attributes extends external_api {
    /**
    ...
    /**
     * Fetch custom attribute options for a course activity form.
     *
    ...
    public static function execute(int $courseid): array {
        ...
        try {
            $data = [];
            foreach ($client->get_custom_attributes() as $attribute) {
                $data[] = [
            ...
            debugging('Certifier custom attributes fetch failed: ' . $exception->getMessage(), DEBUG_DEVELOPER);
            return [
                'configured' => true,
                'message' => '',
    ...
    public static function execute_returns(): external_single_structure {
        return new external_single_structure([
            ...
            'data' => new external_multiple_structure(new external_single_structure([
                'tag' => new external_value(PARAM_TEXT, 'Custom attribute tag'),
